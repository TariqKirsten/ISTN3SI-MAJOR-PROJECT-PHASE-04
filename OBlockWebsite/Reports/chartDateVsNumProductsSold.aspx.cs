...
{
    public partial class chartDateVsNumProductsSold : System.Web.UI.Page
    {
        ...
        private void ShowData()
        {
            ...
            DataSetTableAdapters.SaleDateVsQSoldTableAdapter TA = new DataSetTableAdapters.SaleDateVsQSoldTableAdapter();
            TA.Fill(DS.SaleDateVsQSold);
            ...
            String barColour = "#e625a5";//bar colour
            String xAxisBoxLabel = "Date";//same as x axis title
            String xAxisTitle = "Date";
            String yAxisLabel = "No. of Products Sold";
            String chartTitle = "Date Vs. No. of Products Sold";
            //X AXIS LABELS
            for (int i = 0; i < DS.SaleDateVsQSold.Rows.Count; i++)
            {
                String prod = DS.SaleDateVsQSold.Rows[i][0].ToString();
            ...
            for (int i = 0; i < DS.SaleDateVsQSold.Rows.Count; i++)
            {
                String v = DS.SaleDateVsQSold.Rows[i][1].ToString();
                v = v.Replace(",", ".");
                value += v + ",";
            }
