<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="OBlockWebsite.EditProduct" %>
      ...
      <div class="form-horizontal">
       ...
       <div class="form-group">
           <div class="col-md-2"></div>
               <div class="col-md-6">
                    <asp:Button ID="buttonUpdateProduct" runat="server" Text="Add Product" CssClass="btn btn-default" OnClick="buttonUpdateProduct_Click"/>
               </div>
       </div>
        <div class="form-group">
            <div class="col-md-2"></div>
            <div class ="col-md-6">
              <asp:Label ID="productUpdatedStatus" runat="server" Text="" CssClass="text-success"></asp:Label>
